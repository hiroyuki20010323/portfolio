...
const Footer = () => {
 ...
 useEffect(() => {
  ...
  return (
    <>
     <Paper sx={{ width:'100vw',position:'fixed', bottom: 0, left: 0, right: 0, padding:1,borderTop:'solid 2px #E0E0E0',marginTop:2,height:'70px',zIndex:99}} elevation={0} >
      <BottomNavigation 
      value={value}
      onChange={handleChange}>
        ...
        <BottomNavigationAction label="ユーザー"value='/profile' icon={<Avatar sx={{width:'28px' ,height:'28px'}} />} component={Link} to='/profile' />
